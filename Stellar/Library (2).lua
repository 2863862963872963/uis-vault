...
function Library.Sections:AddTab(NameOrData, Icon)
    ...
    -- First call: build the tab bar and content wrapper inside the section
    if not self._SectionTabsInit then
        ...
        self._SectionTabBar = Instances:Create("Frame", {
            Parent = self.Items["Section"].Instance,
            Name   = "\0",
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
            Position = UDim2New(0, 0, 0, 40),
        ...
        -- Wrapper that sits below the tab bar; AutomaticSize driven by the active child
        self._SectionTabContent = Instances:Create("Frame", {
            Parent = self.Items["Section"].Instance,
            Name   = "\0",
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
        ...
        -- Hide the plain content area so AutomaticSize isn't confused
        self.Items["Content"].Instance.Visible = false
    end
    ...
    -- Per-tab content frame
    local SubContent = Instances:Create("Frame", {
        Parent = self._SectionTabContent.Instance,
        Name   = "\0",
        BackgroundTransparency = 1,
        BorderSizePixel = 0,
        Size  = UDim2New(1, 0, 0, 0),
    ...
    -- SubTab behaves exactly like a Section (has Toggle, Slider, Button, etc.)
    ...
    local function ActivateTab(Target)
        ...
        for _, E in self._SectionSubTabs do
            ...
            E.Content.Instance.Visible = Active
    ...
    -- Auto-activate the very first tab
